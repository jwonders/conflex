...
public class BoxedDoubleParserPropertyInjector implements ConflexPropertyInjector {

	private static final Logger LOG = 
			Logger.getLogger(BoxedDoubleParserPropertyInjector.class);
	
	private Double fallback;

	public BoxedDoubleParserPropertyInjector() {
		this.fallback = 0.0;
	}

	public BoxedDoubleParserPropertyInjector(Double fallback) {
