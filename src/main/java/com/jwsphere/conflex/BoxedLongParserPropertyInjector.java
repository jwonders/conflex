...
public class BoxedLongParserPropertyInjector implements ConflexPropertyInjector {

	private static final Logger LOG = 
			Logger.getLogger(BoxedLongParserPropertyInjector.class);
	
	private Long fallback;

	public BoxedLongParserPropertyInjector() {
		this.fallback = 0l;
	}

	public BoxedLongParserPropertyInjector(Long fallback) {
